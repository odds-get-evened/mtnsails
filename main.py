...
def taber_bridge(args):
    ...
    try:
        output = executor.run(
            ...
            natural_language_report=not args.raw_output,
        )
        print(output)
...
def main():
    ...
    taber_parser.add_argument('--raw-output', action='store_true',
                              help='Return the raw structured predictor output instead of a '
                                   'natural-language report generated by the LLM')
